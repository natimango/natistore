...
export const metadata: Metadata = {
  title: 'NATI Admin Console - Master Control Panel',
  description: 'Complete control over your AI marketing agent and business operations',
};
      ...
      <div className="flex grow flex-col gap-y-5 overflow-y-auto border-r border-gray-200 bg-white px-6 pb-4">
        <div className="flex h-16 shrink-0 items-center">
          <img
            ...
            alt="NATI"
          />
          <span className="ml-2 text-xl font-bold text-gray-900">Admin Console</span>
        </div>
